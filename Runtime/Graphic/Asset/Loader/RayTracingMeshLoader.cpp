#include "RayTracingMeshLoader.hpp"
#include <fstream>
...
AirEngine::Runtime::Asset::AssetBase* AirEngine::Runtime::Graphic::Asset::Loader::RayTracingMeshLoader::OnLoadAsset(const std::string& path, std::shared_future<void>& loadOperationFuture, bool& isInLoading)
{
...
void AirEngine::Runtime::Graphic::Asset::Loader::RayTracingMeshLoader::OnUnloadAsset(AirEngine::Runtime::Asset::AssetBase* asset)
{
	delete static_cast<AirEngine::Runtime::Graphic::Asset::Mesh*>(asset);
}

void AirEngine::Runtime::Graphic::Asset::Loader::RayTracingMeshLoader::PopulateMesh(AirEngine::Runtime::Graphic::Asset::Mesh* mesh, const std::string path, bool* isInLoading)
{
	// Load descriptor
...
AirEngine::Runtime::Graphic::Asset::Loader::RayTracingMeshLoader::RayTracingMeshLoader()
	: LoaderBase("RayTracingMeshLoader", "mesh")
{
