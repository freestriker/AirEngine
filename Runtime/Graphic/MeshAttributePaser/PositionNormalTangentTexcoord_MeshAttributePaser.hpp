		...
		namespace Graphic
		{
			namespace MeshAttributePaser
			{
				...
				protected:
					...
					AirEngine::Runtime::Utility::InternedString OnPopulateMeshVertexAttributeInfoMap(MeshAttributePaser::MeshVertexAttributeInfoMap& meshVertexAttributeInfoMap) const override;
